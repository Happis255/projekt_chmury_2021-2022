...
('d4c5411d-10d7-4319-bf23-8b341bcb27f0', 'Makijaz Okolicznościowy','Doklejanie Rzes',NULL, '30', '15', NULL, NULL),
('7696c0db-a3e9-49d7-b2fd-d1b9405d16e5', 'Makijaz Okolicznościowy','Makijaz Probny',NULL, '100', '15', NULL, NULL),
('029c34b1-cb46-4e7e-93a7-ca8b124d6de2', 'Makijaz Okolicznościowy','Makijaz Slubny',NULL, '150', '30', NULL, NULL),
('eb209883-be92-4ff6-927b-461552939b16', 'Makijaz Okolicznościowy','Makijaz Fotograficzny',NULL, '100', '60', NULL, NULL),
('44cee85f-54ac-4bf7-9c1f-d2eb383aec4a', 'Makijaz Okolicznościowy','Makijaz Dzienny',NULL, '100', '60', NULL, NULL),
('e9feb703-388f-41b4-91ae-a5566f714198', 'Makijaz Okolicznościowy','Makijaz Sylwestrowy',NULL, '100', '45', NULL, NULL),
...
('51a3bb8a-61c4-4075-a80d-14dc354f089b', 'Karboksyterapia','Podbrodek',NULL, '100', '15', NULL, NULL),
('ea6c1bb3-30ff-4a05-bdb1-906b8d4d82ef', 'Karboksyterapia','Okolice Oczu',NULL, '150', '60', NULL, NULL),
('b2ca82f0-d223-46ff-903a-44d8a7171525', 'Karboksyterapia','Skora Glowy',NULL, '200', '60', NULL, NULL),
('6b1ca333-1cf8-47d6-85ca-80a097178892', 'Mezoterapia','FXBC-Body (Cialo)',NULL, '500', '60', NULL, NULL),
...
('37b7cb67-fc67-4c24-8bed-ee57752a6df1', 'Kosmetyka z Aparatura','Kawitacja','BEZBOLESNE OCZYSZCZANIE SKOR WRAZLIWYCHL', '150', '60', NULL, NULL),
('345d43fb-70de-4405-b6f0-cfe1a8231839', 'Kosmetyka z Aparatura','Mezoterapia Mikroiglowa BDR','BEAUTY DEFECT REPAIR – ALTERNATYWA ZABIEGOW CHIRURGII ESTETYCZNEJ', '350', '45', NULL, NULL),
('8a715f67-3746-4427-aaa6-20804b190701', 'Kosmetyka z Aparatura','Mikrodermabrazja','BEZBOLESNE OCZYSZCZANIE GLOWICA DIAMENTOWA', '150', '30', NULL, NULL),
('6016050f-34e2-488b-9f7d-87e76bc81b09', 'Kosmetyka z Aparatura','Zabiegi Liftingujace Sculptor II Focus RF3D V.2','FOCUS TECHNOLOGY RF TO BEZINWAZYJNY TERMOLIFTING', '300', '15', NULL, NULL),
('cf1ace1b-9015-44d1-9638-3d81e62c35df', 'Pielegnacja Twarzy','Zabieg Migdalowy Natinuel','KURACJA ODMLADZAJACO REGENERUJACA, WYROWNUJE I UTRWALA OPALENIZNE CHRONI DNA KOMOREK, NAWILZA I UJEDNOLICA KOLORYT SKORY', '150', '60', NULL, NULL),
('2ce2d3b2-33c8-4f50-be21-29fd2abaee39', 'Pielegnacja Twarzy','Zabiegi Pielegnacyjne Anna Lotan-Pro','TWARZ-SZYJA-DEKOLT DOSKONALA TOLERANCJA, KLUCZOWA FORMULA WYSOCE WYSELEKCJONOWANYCH MINERALNYCH SKLADNIKOW (BIOMIMETYKI)', '150', '60', NULL, NULL),
('86351a01-ff9b-4e1d-86a0-389fab403d9b', 'Pielegnacja Twarzy','Zabiegi Stymulujace OnMacabim','TWARZ-SZYJA-DEKOLT CERTYFIKOWANA JAKOSC NANOTECHNOLOGII, DOBIERZEMY ODPOWIEDNIA UNIKATOWA LINIE MODULOWA DLA POTRZEB TWOJEJ SKORY', '180', '30', NULL, NULL),
('8898d2ed-83cd-4de9-9210-4a557fe86f94', 'Pielegnacja Twarzy','Leczniczy Zabieg Cer Tradzikowych','PS MED C.P.R. – NA BAZIE AKTYWATOROW I STABILIZATOROW SKORY', '150', '30', NULL, NULL),
('4a1524d8-bce9-4335-9ad6-e722e77f0e1c', 'Pielegnacja Twarzy','Gleboki Zabieg Oczyszczenia','Z INIEKCJA ZASKORNIKOW ZAMKNIETYCH', '150', '45', NULL, NULL),
('c100f763-b82d-47a9-a42e-1d5ce3ef7777', 'Pielegnacja Twarzy','Klasyczny Zabieg Oczyszczenia','Z WYKORZYSTANIEM CISNIENIA OSMOTYCZNEGO SKORY ANNA LOTAN', '150', '30', NULL, NULL),
('f926de96-6e24-4d29-8d17-1dc3d3fb0402', 'Kosmetyka Twarzy','Depilacja Wasika','WOSKOWANIE', '15', '15', NULL, NULL),
('40d8c514-3273-4faa-ad51-f18d61498ce6', 'Kosmetyka Twarzy','Henna Brwi Pudrowa','POZADANY ODCIEŃ, MAPOWANIE BRWI, STYLIZACJA, REGULACJA WOSKIEM I PESETA', '80', '60', NULL, NULL),
('447140f0-3e9c-478c-bad4-562f65355181', 'Kosmetyka Twarzy','Pakiet Henna Z Regulacja','ZAWIERA WSZYSTKIE POWYZSZE USLUGI', '40', '30', NULL, NULL),
('a316c388-be57-46ac-bc63-000ddfd0dd02', 'Kosmetyka Twarzy','Regulacja Brwi','WOSK/PESETKA, DOBOR KSZTALTU', '15', '30', NULL, NULL),
('801e33ec-4ea1-42e9-af1a-6601c6fc065f', 'Kosmetyka Twarzy','Henna Rzes','CZARNA PROSZKOWAll', '15', '30', NULL, NULL),
('2ca7974e-18d4-4980-9c10-8fcedce09044', 'Kosmetyka Twarzy','Henna Brwi Proszkowa', 'POZADANY ODCIEŃ', '15', '15', NULL, NULL);
