...
('b3ad495d-3acd-47e0-84a5-6c9e4c8417a9', 'Anna', 'Wasik', 'Modrzewiowa 20', '31-450', 'Stalowa Wola', '1970-10-01', '787878787', '70100100693', '2020-10-01', NULL, '9cb799a5-9212-474f-a0c9-691ffde0d7db'),
('3ea6d2ad-c413-47ad-b6d6-6e1bede488a7', 'Aleksandra', 'Wasik', 'Modrzewiowa 20', '31-450', 'Stalowa Wola', '1970-10-01', '787878787', '70100100693', '2020-10-01', NULL, 'c49a059f-db35-475e-b387-7b37fe512260'),
...
INSERT INTO `service` (`uuid`, `active`, `type`, `name`, `description`, `price`, `time`, `advices`, `promotion_uuid`) VALUES 
('d4c5411d-10d7-4319-bf23-8b341bcb27f0', 1, 'Makijaz Okolicznościowy','Doklejanie Rzes',NULL, '30', '15', NULL, NULL),
('7696c0db-a3e9-49d7-b2fd-d1b9405d16e5', 1, 'Makijaz Okolicznościowy','Makijaz Probny',NULL, '100', '15', NULL, NULL),
('029c34b1-cb46-4e7e-93a7-ca8b124d6de2', 1, 'Makijaz Okolicznościowy','Makijaz Slubny',NULL, '150', '30', NULL, NULL),
('eb209883-be92-4ff6-927b-461552939b16', 1, 'Makijaz Okolicznościowy','Makijaz Fotograficzny',NULL, '100', '60', NULL, NULL),
('44cee85f-54ac-4bf7-9c1f-d2eb383aec4a', 1, 'Makijaz Okolicznościowy','Makijaz Dzienny',NULL, '100', '60', NULL, NULL),
('e9feb703-388f-41b4-91ae-a5566f714198', 1, 'Makijaz Okolicznościowy','Makijaz Sylwestrowy',NULL, '100', '45', NULL, NULL),
('e5152a68-83a9-4a52-b297-924c2f77561d', 1, 'Karboksyterapia','Twarz',NULL, '250', '45', NULL, NULL),
('3ba022b3-2a39-4360-b532-a91244a6a35f', 1, 'Karboksyterapia','Dekolt',NULL, '150', '30', NULL, NULL),
('51a3bb8a-61c4-4075-a80d-14dc354f089b', 1, 'Karboksyterapia','Podbrodek',NULL, '100', '15', NULL, NULL),
('ea6c1bb3-30ff-4a05-bdb1-906b8d4d82ef', 1, 'Karboksyterapia','Okolice Oczu',NULL, '150', '60', NULL, NULL),
('b2ca82f0-d223-46ff-903a-44d8a7171525', 1, 'Karboksyterapia','Skora Glowy',NULL, '200', '60', NULL, NULL),
('6b1ca333-1cf8-47d6-85ca-80a097178892', 1, 'Mezoterapia','FXBC-Body (Cialo)',NULL, '500', '60', NULL, NULL),
('5d419e06-09f1-4a73-aac0-d61e3a78f018', 1, 'Mezoterapia','F-Vitamin C',NULL, '300', '45', NULL, NULL),
('578c6e45-32ef-472f-9709-7b9a43e747b5', 1, 'Mezoterapia','FXFC - Rozświetlenie',NULL, '400', '15', NULL, NULL),
('923ff0cb-7f2e-4d7a-9779-a2aaa7ae76f2', 1, 'Mezoterapia','F-Vitamin Ace',NULL, '250', '30', NULL, NULL),
('181a1419-254b-49c6-9eb7-13ffa0a37686', 1, 'Mezoterapia','F-Lift+Face',NULL, '500', '60', NULL, NULL),
('9eb5111d-d728-4d3e-ae8a-ccc84b2d8993', 1, 'Mezoterapia','F-Ha+ (Kwas Hialuronowy)',NULL, '350', '30', NULL, NULL),
('ae5d1361-f426-4434-adf8-4688a553c5ac', 1, 'Mezoterapia','F-Eye Contour Fusion',NULL, '250', '15', NULL, NULL),
('37b7cb67-fc67-4c24-8bed-ee57752a6df1', 1, 'Kosmetyka z Aparatura','Kawitacja','BEZBOLESNE OCZYSZCZANIE SKOR WRAZLIWYCHL', '150', '60', NULL, NULL),
('345d43fb-70de-4405-b6f0-cfe1a8231839', 1, 'Kosmetyka z Aparatura','Mezoterapia Mikroiglowa BDR','BEAUTY DEFECT REPAIR – ALTERNATYWA ZABIEGOW CHIRURGII ESTETYCZNEJ', '350', '45', NULL, NULL),
('8a715f67-3746-4427-aaa6-20804b190701', 1, 'Kosmetyka z Aparatura','Mikrodermabrazja','BEZBOLESNE OCZYSZCZANIE GLOWICA DIAMENTOWA', '150', '30', NULL, NULL),
('6016050f-34e2-488b-9f7d-87e76bc81b09', 1, 'Kosmetyka z Aparatura','Zabiegi Liftingujace Sculptor II Focus RF3D V.2','FOCUS TECHNOLOGY RF TO BEZINWAZYJNY TERMOLIFTING', '300', '15', NULL, NULL),
('cf1ace1b-9015-44d1-9638-3d81e62c35df', 1, 'Pielegnacja Twarzy','Zabieg Migdalowy Natinuel','KURACJA ODMLADZAJACO REGENERUJACA, WYROWNUJE I UTRWALA OPALENIZNE CHRONI DNA KOMOREK, NAWILZA I UJEDNOLICA KOLORYT SKORY', '150', '60', NULL, NULL),
('2ce2d3b2-33c8-4f50-be21-29fd2abaee39', 1, 'Pielegnacja Twarzy','Zabiegi Pielegnacyjne Anna Lotan-Pro','TWARZ-SZYJA-DEKOLT DOSKONALA TOLERANCJA, KLUCZOWA FORMULA WYSOCE WYSELEKCJONOWANYCH MINERALNYCH SKLADNIKOW (BIOMIMETYKI)', '150', '60', NULL, NULL),
('86351a01-ff9b-4e1d-86a0-389fab403d9b', 1, 'Pielegnacja Twarzy','Zabiegi Stymulujace OnMacabim','TWARZ-SZYJA-DEKOLT CERTYFIKOWANA JAKOSC NANOTECHNOLOGII, DOBIERZEMY ODPOWIEDNIA UNIKATOWA LINIE MODULOWA DLA POTRZEB TWOJEJ SKORY', '180', '30', NULL, NULL),
('8898d2ed-83cd-4de9-9210-4a557fe86f94', 1, 'Pielegnacja Twarzy','Leczniczy Zabieg Cer Tradzikowych','PS MED C.P.R. – NA BAZIE AKTYWATOROW I STABILIZATOROW SKORY', '150', '30', NULL, NULL),
('4a1524d8-bce9-4335-9ad6-e722e77f0e1c', 1, 'Pielegnacja Twarzy','Gleboki Zabieg Oczyszczenia','Z INIEKCJA ZASKORNIKOW ZAMKNIETYCH', '150', '45', NULL, NULL),
('c100f763-b82d-47a9-a42e-1d5ce3ef7777', 1, 'Pielegnacja Twarzy','Klasyczny Zabieg Oczyszczenia','Z WYKORZYSTANIEM CISNIENIA OSMOTYCZNEGO SKORY ANNA LOTAN', '150', '30', NULL, NULL),
('f926de96-6e24-4d29-8d17-1dc3d3fb0402', 1, 'Kosmetyka Twarzy','Depilacja Wasika','WOSKOWANIE', '15', '15', NULL, NULL),
('40d8c514-3273-4faa-ad51-f18d61498ce6', 1, 'Kosmetyka Twarzy','Henna Brwi Pudrowa','POZADANY ODCIEŃ, MAPOWANIE BRWI, STYLIZACJA, REGULACJA WOSKIEM I PESETA', '80', '60', NULL, NULL),
('447140f0-3e9c-478c-bad4-562f65355181', 1, 'Kosmetyka Twarzy','Pakiet Henna Z Regulacja','ZAWIERA WSZYSTKIE POWYZSZE USLUGI', '40', '30', NULL, NULL),
('a316c388-be57-46ac-bc63-000ddfd0dd02', 1, 'Kosmetyka Twarzy','Regulacja Brwi','WOSK/PESETKA, DOBOR KSZTALTU', '15', '30', NULL, NULL),
('801e33ec-4ea1-42e9-af1a-6601c6fc065f', 1, 'Kosmetyka Twarzy','Henna Rzes','CZARNA PROSZKOWAll', '15', '30', NULL, NULL),
('2ca7974e-18d4-4980-9c10-8fcedce09044', 1, 'Kosmetyka Twarzy','Henna Brwi Proszkowa', 'POZADANY ODCIEŃ', '15', '15', NULL, NULL);
...
('5747e0b9-ef9f-4658-891d-145476f0d91b', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-11', 'Przykladowy tekst 01', NULL, 'SYSTEM', 'CONFIRMED'),
('428897dd-fc3c-47d4-850f-7750487edd10', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-12', 'Przykladowy tekst 02', NULL, 'SYSTEM', 'DELETED'),
('4a3c10af-2ea4-4ecf-8646-b579622e5180', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-13', 'Przykladowy tekst 03', NULL, 'SYSTEM', 'DELETED'),
('5870b29c-92bd-483f-ae66-393f5d479dd9', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-14', 'Przykladowy tekst 04', NULL, 'SYSTEM', 'CONFIRMED'),
('b41a8d96-1f31-4e6d-bb88-d4b3c638c0be', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-15', 'Przykladowy tekst 05', NULL, 'SYSTEM', 'NOT_CONFIRMED'),
('41a948f7-0de4-4f71-af62-f7bd4f6d8762', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-16', 'Przykladowy tekst 06', NULL, 'SYSTEM', 'CONFIRMED'),
('3071d111-80f3-4722-aa5c-16a1494b5420', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-17', 'Przykladowy tekst 07', NULL, 'SYSTEM', 'NOT_CONFIRMED'),
('2f97fd3e-0d93-40e8-bf2e-dca9cf5742eb', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-09', 'Przykladowy tekst 08', NULL, 'SYSTEM', 'NOT_CONFIRMED'),
('e2aab0ce-57f9-4687-99d5-235b68d6d9cf', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-17', 'Przykladowy tekst 09', "9cb799a5-9212-474f-a0c9-691ffde0d7db", 'FROM_USER', 'NOT_CONFIRMED'),
('f2ec1567-a10f-4664-b53c-d045bd85227e', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-22', 'Przykladowy tekst 10', "f27bc27b-7bf9-45d7-90a8-8a601c4d776d", 'FROM_USER', 'NOT_CONFIRMED'),
('10acba15-8192-4358-aaaf-093b843dba0b', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-12', 'Przykladowy tekst 11', "c49a059f-db35-475e-b387-7b37fe512260", 'FROM_USER', 'NOT_CONFIRMED'),
('450dd528-27aa-43a2-8e5c-a66fba3fb058', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-13', 'Przykladowy tekst 12', "c49a059f-db35-475e-b387-7b37fe512260", 'FROM_USER', 'NOT_CONFIRMED'),
('463891ae-2563-48c0-878f-d7baa1198fb4', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-11', 'Przykladowy tekst 13', "5d2ae656-72f4-4480-a1aa-a520f9852d46", 'FROM_CLIENT', 'NOT_CONFIRMED'),
('79aec34a-c204-413b-b9cf-3a7eae561df2', '9cb799a5-9212-474f-a0c9-691ffde0d7db', '2020-10-12', 'Przykladowy tekst 14', "07539cc3-5595-4e77-8be8-46edb69f8372", 'FROM_CLIENT', 'NOT_CONFIRMED');

INSERT INTO `product_for_sell` (`uuid`, `name`, `description`, `price`, `amount`, `promotion_uuid`) VALUES 
('cdcf0f9d-d160-4688-8054-e0478f5959d6', 'LIRENE RETINOL D-FORTE', 'PREPARAT ODMLADZAJACY', '99.99', '20', NULL),
...
('5857e741-1b05-4049-ae3d-1c49dfbcaff4', 'MARY KAY', 'INTENSYWNIE REGENERUJACY KREM POD OCZY', '329.99', '5', NULL),
('97392c68-0eb8-4daf-867b-b12898d8f238', 'MARY KAY KREM NAWILZAJACO', 'PREPARAT ODMLADZAJACY ', '329.99', '20', NULL),
('0a9e8692-f32d-41fc-b745-ad4c1e98f3de', 'TimeWise', 'REGENERUJACY ', '439.99', '60', NULL),
...
('1a21f926-2c98-4636-bd07-07c305653bfa', 'Tytul 01', 'Description 02', '2020-10-01', '2c4abc41-079a-4366-bb41-aded977754b1'),
('214e0aba-d5bd-44d9-aecf-4a7b672097a7', 'Tytul 01', 'Description 01', '2020-10-11', '2c4abc41-079a-4366-bb41-aded977754b1'),
('4a7496cc-a1bc-40ee-8dbf-7a1c79fdfbd7', 'Tytul 02', 'Description 02', '2020-10-21', '2c4abc41-079a-4366-bb41-aded977754b1'),
('4fcdb6f0-d7f8-4bb3-9810-c68f9b197a0e', 'Tytul 03', 'Description 03', '2020-10-22', '2c4abc41-079a-4366-bb41-aded977754b1'),
('2bd95af4-4aa1-4ab1-be29-65bec770fd9a', 'Tytul 04', 'Description 04', '2020-10-15', '2c4abc41-079a-4366-bb41-aded977754b1'),
('87eaf4a5-2e16-4d4f-bd77-aab2a7cc9800', 'Tytul 05', 'Description 05', '2020-10-16', '2c4abc41-079a-4366-bb41-aded977754b1'),
('3f8c212e-a3a9-44c3-ae85-ec15e159dd16', 'Tytul 06', 'Description 06', '2020-10-17', '2c4abc41-079a-4366-bb41-aded977754b1');
